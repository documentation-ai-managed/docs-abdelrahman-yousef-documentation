...
description: >-
  Learn how to organize, edit, and structure your project documentation
...
<Columns cols="3">
  <Card title="Create Pages" href="#creating-pages" icon="file-plus" horizontal="false">
    Build new documentation pages quickly.
  </Card>

  <Card title="Organize Hierarchy" href="#hierarchy" icon="folder" horizontal="false">
    Structure your content for easy navigation.
  </Card>

  <Card title="Collaborate" href="#collaboration" icon="users" horizontal="false">
...
<Steps>
  <Step title="Create a New Page" icon="plus" title-type="p">
  ...
  <Step title="Preview and Publish" icon="eye" title-type="p">
